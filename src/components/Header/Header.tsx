        ...
        <div className="container">
          <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
              <li><NavLink className="nav-link px-2 text-secondary" to="/">Trang Chủ</NavLink></li>
              <li><NavLink className="nav-link px-2 text-white" to="/product">Sản Phẩm</NavLink></li>
              <li><NavLink className="nav-link px-2 text-white" to="/about">Về Chúng Tôi</NavLink></li>
            </ul>
